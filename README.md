# KeyAuth-JavaScript-Example : Please star 🌟

KeyAuth JavaScript example SDK for https://keyauth.cc license key API auth.

### Tutorial Video

This video explains both how to use this example, but also how to add KeyAuth to your <ins>**OWN PROJECT**</ins> Link coming soon:
